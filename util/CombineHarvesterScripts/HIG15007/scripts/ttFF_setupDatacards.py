...
files = {
    'tt': {
        'Wisconsin': 'htt_tt.inputs-sm-13TeV_svFitMass-FFv4.root' # Met Syst svFit
        #'Wisconsin': 'htt_tt.inputs-sm-13TeV_svFitMass-FFv2.root' # non-Met Syst svFit
        #'Wisconsin': 'htt_tt.inputs-sm-13TeV_visMass-FFv2.root'
    },
}
...
#        (['tt'], {2},  1.30) # tt_1jet
#        (['tt'], {3},  1.30) # tt_2jet
#        (['tt'], {4},  1.30) # tt_1jet_low
#        (['tt'], {5},  1.30) # tt_1jet_medium
#        (['tt'], {6},  2.0) # tt_1jet_high
#        (['tt'], {7},  2.0) # tt_vbf
#        (['tt'], {8},  2.0) # tt_1bjet
#        (['tt'], {9},  2.0) # tt_2bjet
#        )
...
# Write the cards
######################################################################################
writer = ch.CardWriter('$TAG/datacardFF.txt',
                       '$TAG/shapes.root')
...
print x
x['output/LIMITS/cmb/datacardFF.txt'].PrintAll()
