...
def tBase( lep ) :
    ...
    #return 'LEG_Pt > 20 && abs(LEG_Eta) < 2.3 && LEG_DecayModeFinding == 1 && abs(LEG_PVDZ) < 0.2 && LEG_AgainstElectronVLooseMVA6 == 1 && LEG_AgainstMuonLoose3 == 1 && abs( LEG_Charge ) == 1 && LEG_ByIsolationMVArun2v1DBoldDMwLTraw > -0.8'.replace('LEG_',lep)
def tTight( lep ) :
