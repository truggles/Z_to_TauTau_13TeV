...
def tagAndProbeAnalyzer( mpCount, lumiJSON, targetFile, maxEvents, doLumi=True, localFile=False, includeTrigger=True ) :
    print "TAG-AND-PROBE ANALYZER CALLED:"
    print "Count: %i    targetFile %s" % (mpCount, targetFile)
    ...
    import os
    outName = targetFile.strip('.root').split('/')
    tFile = ROOT.TFile('processed/'+outName[-1]+'.root', 'RECREATE')
...
if __name__ == '__main__' :    
    ...
    targetFile = '/store/data/Run2016D/SingleMuon/MINIAOD/PromptReco-v2/000/276/528/00000/82386779-BF49-E611-ADD4-02163E013499.root'
    maxEvents = 999999
    tagAndProbeAnalyzer( mpCount, lumiJSON, targetFile, maxEvents)
