...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'root://eoscms//eos/cms/store/relval/CMSSW_8_0_0_pre6/RelValTTbar_13/GEN-SIM-RECO/80X_mcRun2_asymptotic_v4-v1/10000/32A69D03-F1D0-E511-A084-0CC47A4D76AA.root',
        'root://eoscms//eos/cms/store/relval/CMSSW_8_0_0_pre6/RelValTTbar_13/GEN-SIM-RECO/80X_mcRun2_asymptotic_v4-v1/10000/5A20DFCA-F0D0-E511-B76A-0025905A6060.root',
        'root://eoscms//eos/cms/store/relval/CMSSW_8_0_0_pre6/RelValTTbar_13/GEN-SIM-RECO/80X_mcRun2_asymptotic_v4-v1/10000/A42F77B4-E3D0-E511-9ACF-0CC47A78A436.root',
        'root://eoscms//eos/cms/store/relval/CMSSW_8_0_0_pre6/RelValTTbar_13/GEN-SIM-RECO/80X_mcRun2_asymptotic_v4-v1/10000/D62B8277-E2D0-E511-AC66-0CC47A4D7654.root', 
        ),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ttbar_800 nevts:99999'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ttbar_800_PAT.root'),
