...
#        'npv' : ('npv', 50, 0, 50),
#        'npu' : ('npu', 50, 0, 50),
        'm_vis_mssm' : ('m_vis', 4000, 0, 4000),
#        'm_vis_varB' : ('m_vis', 600, 0, 600),
        'm_vis' : ('m_vis', 3500, 0, 350),
        'm_sv_mssm' : ('m_sv', 4000, 0, 4000),
#        'm_sv_varB' : ('m_sv', 600, 0, 600),
        'm_sv' : ('m_sv', 3500, 0, 350),
        'mt_sv_mssm' : ('mt_sv', 4000, 0, 4000),
#        'mt_sv_varB' : ('mt_sv', 600, 0, 600),
        'mt_sv' : ('mt_sv', 3500, 0, 350),
#        'pt_1' : ('pt_1', 400, 0, 400),
#        'eta_1' : ('eta_1', 80, -4, 4),
#XXX        'iso_1' : ('iso_1', 100, 0, 1),
        'iso_1' : ('byIsolationMVArun2v1DBoldDMwLTraw_1', 200, -1, 1),
#        'mt_1' : ('mt_1', 400, 0, 400),
#        'pt_2' : ('pt_2', 400, 0, 400),
#        'eta_2' : ('eta_2', 80, -4, 4),
#XXX        'iso_2' : ('iso_2', 100, 0, 1),
        'iso_2' : ('byIsolationMVArun2v1DBoldDMwLTraw_2', 200, -1, 1),
#        'mt_2' : ('mt_2', 400, 0, 400),
...
def getPlotDetails( channel ) :
    plotDetails = {
        'm_vis_mssm' : (0, 4000, 10, 'Z Vis Mass [GeV]', ' GeV'),
        'm_vis_varB' : (0, 600, 10, 'Z Vis Mass [GeV]', ' GeV'),
       'm_vis' : (0, 350, 100, 'Z Vis Mass [GeV]', ' GeV'),
#XXX        'm_vis' : (0, 350, 1, 'Z Vis Mass [GeV]', ' GeV'),
        'm_sv_mssm' : (0, 4000, 10, 'Z svFit Mass [GeV]', ' GeV'),
        'm_sv_varB' : (0, 600, 10, 'Z svFit Mass [GeV]', ' GeV'),
        'm_sv' : (0, 350, 100, 'Z svFit Mass [GeV]', ' GeV'),
#XXX        'm_sv' : (0, 350, 1, 'Z svFit Mass [GeV]', ' GeV'),
        'mt_sv_mssm' : (0, 4000, 10, 'Total Transverse Mass [GeV]', ' GeV'),
        'mt_sv_varB' : (0, 600, 10, 'Total Transverse Mass [GeV]', ' GeV'),
        'mt_sv' : (0, 350, 100, 'Total Transverse Mass [GeV]', ' GeV'),
