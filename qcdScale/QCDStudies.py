...
def getHistos() :
    ...
    for cut in cutMap.keys() :
        ...
        c3 = ROOT.TCanvas("c3%s" % cut,"c3",800,800)
        p3 = ROOT.TPad("p3","p3",0,0,1,1)
        p3.Draw()
        p3.cd()
        ratio = ROOT.TH2F("ratio%s" % cut,"(data / MC): %s" % cut,5,xBin,5,xBin)
