...
//  TFile *finput = new TFile("all1234tmpOut2.root");
  ...
  tree->SetBranchAddress("j1pt", &jpt_1, &b_jpt_1);
  tree->SetBranchAddress("j1eta", &jeta_1, &b_jeta_1);
  tree->SetBranchAddress("j1phi", &jphi_1, &b_jphi_1);
  tree->SetBranchAddress("j2pt", &jpt_2, &b_jpt_2);
  tree->SetBranchAddress("j2eta", &jeta_2, &b_jeta_2);
  tree->SetBranchAddress("j2phi", &jphi_2, &b_jphi_2);
  ...
  tree->SetBranchAddress("t1Pt", &pt_1, &b_pt_1);
  tree->SetBranchAddress("t1Phi", &phi_1, &b_phi_1);
  tree->SetBranchAddress("t1Eta", &eta_1, &b_eta_1);
  tree->SetBranchAddress("t1Mass", &m_1, &b_m_1);
  tree->SetBranchAddress("t2Pt", &pt_2, &b_pt_2);
  tree->SetBranchAddress("t2Phi", &phi_2, &b_phi_2);
  tree->SetBranchAddress("t2Eta", &eta_2, &b_eta_2);
  tree->SetBranchAddress("t2Mass", &m_2, &b_m_2);
...
void runAll() {
 ...
 files.push_back("ggH125-maxmix_tt");
 files.push_back("ggH125-pseudoscalar_tt");
 files.push_back("ggH125-sm_tt");

 std::string base = "/data/truggles/svFitApr01_SM-HTT_Merged2/";
