...
def sampleDetails( analysis ) :
    ...
    sampleMap = {
        ...
        'htt' : {
            ...
            #    'group' : 'obs'},
            'dataMT-B' : {
                'DASPath' : '/SingleMuon/Run2017B-31Mar2018-v1/MINIAOD',
                'xsec' : 999.,
                'group' : 'obs'},
            'dataMT-C' : {
                'DASPath' : '/SingleMuon/Run2017C-31Mar2018-v1/MINIAOD',
                'xsec' : 999.,
                'group' : 'obs'},
            'dataMT-D' : {
                'DASPath' : '/SingleMuon/Run2017D-31Mar2018-v1/MINIAOD',
                'xsec' : 999.,
                'group' : 'obs'},
            'dataMT-E' : {
                'DASPath' : '/SingleMuon/Run2017E-31Mar2018-v1/MINIAOD',
                'xsec' : 999.,
                'group' : 'obs'},
            'dataMT-F' : {
                'DASPath' : '/SingleMuon/Run2017F-31Mar2018-v1/MINIAOD',
                'xsec' : 999.,
                'group' : 'obs'},
            #'EWKWMinus' :   { 
