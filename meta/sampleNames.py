...
def sampleDetails( analysis ) :
    ...
    sampleMap = {
        ...
        'htt' : {
            ...
            'WW1l1nu2q' :  { 
                ...
                'group' : 'dib'},
            'WZ2l2q' :     { 
                'DASPath' : '/WZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 5.595,
                'group' : 'dib'},
            'WZ1l3nu' :    { 
                'DASPath' : '/WZTo1L3Nu_13TeV_amcatnloFXFX_madspin_pythia8/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 3.05,
                'group' : 'dib'},
            'WZ1l1nu2q' :  { 
            ...
            'Tbar-tW' :    { 
                ...
                'group' : 'dib'},
            'T-tW' :       { 
                'DASPath' : '/ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/%s-v2/MINIAODSIM' % c80xMAOD2,
                'xsec' : 35.6,
                'group' : 'dib'},
            'T-tchan' :    { 
                'DASPath' : '/ST_t-channel_top_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 136.02,
                'group' : 'dib'},
            'Tbar-tchan' : { 
                'DASPath' : '/ST_t-channel_antitop_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 80.95,
                'group' : 'dib'},
            'TT' :         { 
        ...
        'WandDYJets' : {
            'WJets' :      { 
                'DASPath' : '/WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s_ext1-v1/MINIAODSIM' % c80xReHLT,
                'xsec' : 50380 * 1.221252,
                'group' : 'wjets'},
            'WJets1' :     { 
                'DASPath' : '/W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 9644.5 * 1.221252,
                'group' : 'wjets'},
            'WJets2' :     { 
                'DASPath' : '/W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 3144.5 * 1.221252,
                'group' : 'wjets'},
            'WJets3' :     { 
                'DASPath' : '/W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 954.8 * 1.221252,
                'group' : 'wjets'},
            'WJets4' :     { 
            ...
            'DYJetsOld' :     { 
                ...
                'group' : 'dyj'},
            'DYJets' :     { 
                'DASPath' : '/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s_ext1-v1/MINIAODSIM' % c80xReHLT, 
                'xsec' : 4954.0 * 1.1638,
                'group' : 'dyj'},
            'DYJets1' :    { 
            ...
            'DYJets4' :    { 
                ...
                'group' : 'dyj'},
            'DYJetsHigh' : {
                'DASPath' : '/DYJetsToLL_M-150_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s-v1/MINIAODSIM' % c80xMAOD2,
                'xsec' : 6.657 * 1.1638,
                'group' : 'dyj'},
            'DYJetsLow' :  {
                'DASPath' : '/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/%s-v1/MINIAODSIM' % c80xMAOD2, 
                'xsec' : 18610. * 1.1638,
                'group' : 'dyj'},
	...
	'SM-Higgs' : {
            ...
            'WPlusHTauTau120' : {
                'DASPath' : '/WplusHToTauTau_M120_13TeV_powheg_pythia8/%s-v1/MINIAODSIM' % c80xReHLT,
            ...
            'WPlusHTauTau125' : {
                ...
                'group' : 'VH'},
            'WPlusHTauTau130' : {
                'DASPath' : '/WplusHToTauTau_M130_13TeV_powheg_pythia8/%s-v1/MINIAODSIM' % c80xReHLT,
                'xsec' : 1.209 * 0.0541 * 0.5,
                'group' : 'VH'},

            'WMinusHTauTau120' : {
                'DASPath' : '/WminusHToTauTau_M120_13TeV_powheg_pythia8/%s-v1/MINIAODSIM' % c80xReHLT,
                'xsec' : 1.565 * 0.0698 * 0.5,
                'group' : 'VH'},
            'WMinusHTauTau125' : {
                ...
                'group' : 'VH'},
            'WMinusHTauTau130' : {
                'DASPath' : '/WminusHToTauTau_M130_13TeV_powheg_pythia8/%s-v1/MINIAODSIM' % c80xReHLT,
                'xsec' : 1.209 * 0.0541 * 0.5 ,
                'group' : 'VH'},

            'ZHTauTau120' : {
                'DASPath' : '/ZHToTauTau_M120_13TeV_powheg_pythia8/%s-v1/MINIAODSIM' % c80xReHLT,
                'xsec' : 0.994 * 0.0698,
                'group' : 'VH'},
            'ZHTauTau125' : {
                ...
                'group' : 'VH'},
            'ZHTauTau130' : {
                'DASPath' : '/ZHToTauTau_M130_13TeV_powheg_pythia8/%s-v1/MINIAODSIM' % c80xReHLT,
                'xsec' : 0.790 * 0.0541,
                'group' : 'VH'},
