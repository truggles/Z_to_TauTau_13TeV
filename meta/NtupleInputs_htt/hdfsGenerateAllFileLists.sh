...
for MASS in 120 125 130 140; do
#for MASS in 125; do
    ls ${GGH}/GluGluHToTauTau_M${MASS}_13TeV_powheg_pythia8_v6*/*.root                        > hdfs/ggHtoTauTau${MASS}.txt
...
for MASS in 110; do
    ls ${GGH110}/GluGluHToTauTau_M${MASS}_13TeV_powheg_pythia8_v6*/*.root                        > hdfs/ggHtoTauTau${MASS}.txt
done

# NEW NNLOPS ggH sample
ls ${NNLOPS}/GluGluHToGG_M-125_13TeV_powheg_MINLO_NNLOPS_pythia8_v6-v3/*.root                       > hdfs/ggHtoTauTauNNLOPS125.txt
